...
FAQ:
    ...
    A: If you use a VPN - try selecting a different country (like Netherlands)
         or disable it completely.
       If you don't have a VPN or that didn't help - use ProtonVPN - free version
         works fine, make sure you select Netherlands server.
       If it's too slow consider downloading the files manually (see below).
